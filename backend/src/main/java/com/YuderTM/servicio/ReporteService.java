...
<<<<<<< HEAD
        ...
        InputStream logoStream1 = this.getClass().getResourceAsStream("/img/confienvios2.png"); // Tu nueva imagen
        ...
        if (logoStream1 != null) {
            params.put("logoParam2", logoStream1); // Esta llave debe existir en Jasper
        }else {
...
=======
        ...
        try {
            ...
            // this.getClass().getResourceAsStream("/reports/factura.jasper");
            ...
            // 2. CARGAR EL LOGO
            // Asegúrate de que la ruta sea /img/confienvios.png dentro de
            // src/main/resources
            InputStream logoStream = this.getClass().getResourceAsStream("/img/confienvios.png");
